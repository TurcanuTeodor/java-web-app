...
public class TranzactiiTableService {
    ...
    public void updateTransaction(TranzactiiTable tranzactie) {
        if (tranzactie.getId() != null) {
            TranzactiiTable existent = entityManager.find(TranzactiiTable.class, tranzactie.getId());
            if (existent != null && tranzactie.getDataTranzactie() == null) {
                tranzactie.setDataTranzactie(existent.getDataTranzactie());
            }
        }
